...
/**
 * Read-only listing for the legacy examList.action (Examinations) Struts page.
 ...
 * with the string rows for the exams of the selected type. Reuses
 * {@link SimpleListInterface.Row} for the tabular rows. Additive: introduces no
 * changes to existing behavior.
 *
 * @author Angular migration
 */
public class ExamListInterface implements IsSerializable {
	...
	public static class ExamListRequest implements GwtRpcRequest<ExamListResponse> {
		private Long iExamTypeId;
		private Long iSessionId;

		public ExamListRequest() {}
		...
		@Override
		public String toString() { return "ExamList[type=" + iExamTypeId + ", session=" + iSessionId + "]"; }
	}

	public static class ExamListResponse implements GwtRpcResponse {
