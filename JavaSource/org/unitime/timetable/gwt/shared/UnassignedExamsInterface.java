 ...
 * the selected type that have no committed period assignment
 * ({@code Exam.getAssignedPeriod() == null}). Reuses
 * {@link SimpleListInterface.Row} for the tabular rows. Additive: introduces no
 * changes to existing behavior.
 *
 * @author Angular migration
 */
public class UnassignedExamsInterface implements IsSerializable {
	...
	public static class UnassignedExamsRequest implements GwtRpcRequest<UnassignedExamsResponse> {
		private Long iExamTypeId;
		private Long iSessionId;

		public UnassignedExamsRequest() {}
		...
		@Override
		public String toString() { return "UnassignedExams[type=" + iExamTypeId + ", session=" + iSessionId + "]"; }
	}

	public static class UnassignedExamsResponse implements GwtRpcResponse {
		...
		public UnassignedExamsResponse() {}
