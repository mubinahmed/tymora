 ...
 *   <li>LOAD  - fetch a single manager's editable core fields.</li>
 *   <li>SAVE  - upsert the core fields (externalUniqueId, first/middle/last name,
 *               email). Roles, departments, settings and solver-group assignments
 *               are DEFERRED (never touched here).</li>
